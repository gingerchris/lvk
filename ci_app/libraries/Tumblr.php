...
class Tumblr {
	...
	*/
	function posts($blog_name, $post_id = null, $offset = 0, $amount = 20, $reblog_info = FALSE, $notes = FALSE)
	{
		return json_decode($this->http($this->host . 'blog/' .  $blog_name . '/posts' , '_GET', array('api_key' => $this->tumblr_consumer_key, 'limit' => $amount, 'offset' => $offset, 'reblog_info' => $reblog_info, 'notes_info' => $notes, 'id' => $post_id)));
	}
